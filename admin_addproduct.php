...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
                <h4>
                    <a href="admin_product.php" class="text-decoration-none"><i class="fas fa-backward text-dark" tittle="Back"></i></a>
                </h4>
            <h3><i class="fas fa-plus mr-2"></i> Add Product</h3>
            <hr>
            <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea rows="2" cols="10" name="desc" class="form-control" placeholder="Definition" id="description"></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="addproduct">Submit</button>
                    </div>
