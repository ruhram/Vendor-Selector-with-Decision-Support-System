...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            <a href="admin_admin.php" class="text-decoration-none mb-2"><i class="fas fa-backward text-dark mb-2" tittle="Back"></i></a>
        </h4>
            <h3><i class="fas fa-plus mr-2"></i>Edit Admin</h3>
            <hr>
            <?php
                    $code = $_GET['code'];
                    $edit = "SELECT * FROM `admin` WHERE `id_admin` = '$code'";
                    $query = mysqli_query($conn, $edit);
                    $row = mysqli_fetch_array($query);
                    $_SESSION["code"] = $row['id_admin'];
                    $name = $row['nama_admin'];
                    $nik = $row['nik_admin'];
                    $username = $row['username_admin'];
                    $password = $row['password_admin'];
                    $position = $row['posisi_admin'];
                    $importance = $row['importance_admin'];
            ?>
            <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="password" class="form-control" placeholder="Password" id="password" value="<?php echo $password?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nik" class="form-control" placeholder="NIK" id="nik" value="<?php echo $nik?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="position" class="form-control" placeholder="Position" id="position" value="<?php echo $position?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="editadmin">Submit</button>
                    </div>
                    <br>
                    <br>
                    </form>
