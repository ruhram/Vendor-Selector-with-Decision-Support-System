...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            ...
            <h3><i class="fas fa-plus mr-2"></i> Add Criteria</h3>
            <hr>
            ...
            ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" placeholder="Criteria Name" value="<?php echo $name?>" id="name">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="sector" id="sector">
                                    ...
                                    <option value='Delivery' >1. Delivery</option>
                                    <option value="Delivery" >2. Environment</option>
                                    <option value='Finance' >3. Finance</option>
                                    <option value='Quality' >4. Quality</option>
                                    <option value='Service' >5. Service</option>
                                    <option value="Vendor's background" >6. Vendor's Background</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea rows="2" cols="10" name="desc" class="form-control" placeholder="Description" id="description"><?php echo $description?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="editcriteria">Submit</button>
                    </div>
                    <br>
                    <br>
                    </form>
