...
<html lang="en">
  ...
  <body>
        ...
        <h3><i class="fas fa-cube mr-2"></i>Agreggated Decision Matrix</h3>
        <hr>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
            <?php
                $query = "SELECT DISTINCT code_product, `date` FROM matrix_s ORDER BY code_product ASC";
                ...
                echo "
                    ...
                    <td>$row[date]</td>
                    <td class='text-center'><a href='aggregated_details.php?dm=$row[code_product]'><i class='fas fa-info bg-primary p-2 pr-3 pl-3 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    <td colspan='2' class='text-center'><a class='m-2' href='history_aggregated.php?deleteaggregated=$row[code_product]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
