...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            ?>
            <h5 class="text-danger"> Product Already Available </h5>
            <?php } ?>
            <?php
            if(isset($_GET["cannot"])){
            ?>
            <h5 class="text-danger"> Cannot Delete Product Because Entity Associated With The System </h5>
            <?php } ?>
            <a href="admin_addproduct.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Add Product</a>
            <a href="admin_addproductalternative.php" class="btn btn-info mb-3 ml-2"><i class="fas fa-plus mr-2"></i>Add Product's Alternative</a>
            <a href="admin_addproductcriteria.php" class="btn btn-success mb-3 ml-2"><i class="fas fa-plus mr-2"></i>Add Product's Criteria</a>
            <a href="admin_addproductdm.php" class="btn btn-danger mb-3 ml-2"><i class="fas fa-plus mr-2"></i>Add Product's Decision Manager</a>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM product ORDER BY code_product ASC";
                ...
                echo "
                    ...
                    <td class='text-center'><a href='admin_detailproduct.php?code=$row[code_product]'><i class='fas fa-info bg-primary p-2 pr-3 pl-3 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    <td colspan='2' class='text-center'><a href='edit_product.php?code=$row[code_product]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_product.php?deleteproduct=$row[code_product]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
