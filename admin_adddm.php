...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            ...
            <h3><i class="fas fa-plus mr-2"></i> Add Decision Maker</h3>
            <hr>
            <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="name">Decision Maker Name</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" placeholder="Decision Maker Name" id="name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nik" class="form-control" placeholder="NIK" id="name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="position" class="form-control" placeholder="Position" id="name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="username" class="form-control" placeholder="Username Decision Maker" id="username">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="password" class="form-control" placeholder="Password Decision Maker" id="password">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="importance" id="type">
                                    <option value='' selected>-- Choose Importance --</option>
                    ...
                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="adddm">Submit</button>
                    </div>
                    <br>
                    <br>
                    </form>
