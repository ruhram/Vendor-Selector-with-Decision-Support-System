...
<html lang="en">
  ...
  <body>
        ...
        <h3><i class="fas fa-cubes mr-2"></i> Criteria</h3>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM criteria ORDER BY code_criteria ASC";
                ...
                echo "
                    ...
                    <td class='text-center'><a href='dm_criteria.php?deletecriteria=$row[code_criteria]'><i class='fas fa-info bg-primary p-2 pr-3 pl-3 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
