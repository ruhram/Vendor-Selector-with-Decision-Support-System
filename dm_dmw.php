...
<html lang="en">
  ...
  <body>
        ...
        <h3><i class="fas fa-cube mr-2"></i>Weighted Aggregated Intuitionistic Fuzzy Decision Matrix</h3>
        <hr>
        <table class="table table-striped table-bordered">
            <thead>
                ...
                <th scope="col">µ<sup>^</sup></th>
                <th scope="col">v<sup>^</sup></th>
                <th scope="col">π<sup>^</sup></th>
                </tr>
            </thead>
            <tbody>
            <?php
                $query = "SELECT * FROM matrixweighted";
