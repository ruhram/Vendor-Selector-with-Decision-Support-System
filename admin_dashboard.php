...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-users-cog"></i> Profile Admin</h3>
            <hr>
            <div class="row">
                ...
                <div class="col-md-9">
                    <?php
                        ...
                        $nama = $row['nama_admin'];
                        $nik = $row['nik_admin'];
                        $posisi = $row['posisi_admin'];
                        $importance = $row['importance_admin'];
                    ?>
                    <div class="p-2" id="name">
                        <h7><b><span style="margin-right: 55px;">Name</span> <span class="mr-2">:</span> </b> <?php echo $nama ?></h7>
                    </div>
                    ...
                    <div class="p-2" id="code">
                        <h7><b><span style="margin-right: 60px;">Code</span> <span class="mr-2">:</span> </b> <?php echo $nama ?></h7>
                    </div>
