            ...
            <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" placeholder="Alternative Name" id="name">
                            </div>
                        </div>
                    </div>

                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="addalternative">Submit</button>
                    </div>
                    <br>
                    <br>
                    </form>
