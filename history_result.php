...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            <a href="history.php" class="text-decoration-none mb-2"><i class="fas fa-backward text-dark mb-2" tittle="Back"></i></a>
        </h4>
        <h3><i class="fas fa-history mr-2"></i>Result Score Details</h3>
        <hr>
        <table class="table table-striped table-bordered">
            ...
            <?php
                $code = $_GET["dm"];
                $query = "SELECT * FROM score_s INNER JOIN criteria ON score_s.code_criteria = criteria.code_criteria INNER JOIN rating ON score_s.score = rating.score WHERE score_s.code_dm = '$code'";
