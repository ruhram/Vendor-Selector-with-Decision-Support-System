...
<html lang="en">
  ...
  <body>
        ...
        <h3><i class="fas fa-history mr-2"></i>Result Score</h3>
        <hr>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
            <?php
                $query = "SELECT DISTINCT code_product, `date`, code_dm FROM score_s ORDER BY code_product ASC";
                ...
                echo "
                    ...
                    <td>$row[date]</td>
                    <td>$row[code_dm]</td>
                    <td class='text-center'><a href='history_result.php?dm=$row[code_dm]'><i class='fas fa-info bg-primary p-2 pr-3 pl-3 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    <td colspan='2' class='text-center'><a class='m-2' href='history.php?deletehistory=$row[code_dm]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
