...
<html lang="en">
  ...
  <body>
        ...
        <h3><i class="fas fa-boxes mr-2"></i>Score Criteria</h3>
        <hr>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM score_s INNER JOIN criteria ON score_s.code_criteria = criteria.code_criteria INNER JOIN rating ON score_s.score = rating.score";
