...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            <a href="history_aggregated.php" class="text-decoration-none mb-2"><i class="fas fa-backward text-dark mb-2" tittle="Back"></i></a>
        </h4>
        <h3><i class="fas fa-history mr-2"></i>Aggregated Decision Matrix Details</h3>
        <hr>
        <table class="table table-striped table-bordered">
            ...
            <?php
                $code = $_GET["dm"];
                $query = "SELECT * FROM matrix_s WHERE code_product = '$code'";
