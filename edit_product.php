...
<html lang="en">
  ...
  <body>
        ...
        <h4>
            ...
            <h3><i class="fas fa-boxes mr-2"></i> Edit Product</h3>
            <hr>
            ...
            ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" placeholder="Product Name" id="name" value="<?php echo $product ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea rows="2" cols="10" name="desc" class="form-control" placeholder="Definition" id="description"><?php echo $definition ?></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="text-center mb-5">
                        <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="editproduct">Submit</button>
                    </div>
                    <br>
                    <br>
                    </form>
